import {Skill, SkillEffect, SkillTargetCharacterEnum, SKillTargetPropertyEnum} from "./skill.class";
...
function validateSkillEffect(effect: SkillEffect, index: number): string[] {
  ...
  if (typeof effect !== "object" || effect === null){
    errors.push(`Invalid 'effect' at index ${index}. Effect must be an object.`);
    return errors;
  }
  ...
  if (
    ...
    errors.push(`Invalid 'targetProperty' property at index ${index}. Must be a valid SkillTargetPropertyEnum.`);
  }


  if(typeof effect.value !== 'number') {
    errors.push(`Invalid 'value' property at index ${index}. Must be a number.`);
  }
  ...
  if (
    ...
    errors.push(`Invalid 'targetCharacter' property at index ${index}. Must be a valid SkillTargetCharacterEnum.`);
  }
